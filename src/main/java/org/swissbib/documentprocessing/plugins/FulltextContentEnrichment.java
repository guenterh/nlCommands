...
public class FulltextContentEnrichment implements IDocProcPlugin {
    ...
    private void initializeDBMS(HashMap<String, String> configuration) {
        ...
        if (null != driver && driver.length() > 0) {
            ...
            try {
                ...
                //com.mysql.jdbc.Driver o =  (com.mysql.jdbc.Driver) Class.forName(driver,false,cl).newInstance();
                Object o =   Class.forName(driver,false,cl).newInstance();
    ...
    private void initializeTika(HashMap<String, String> configuration) {
        ...
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        try {
            org.apache.tika.Tika  o =  (org.apache.tika.Tika) (Class.forName("org.apache.tika.Tika", true, cl).newInstance());
            String t = "";
            tika = o;
